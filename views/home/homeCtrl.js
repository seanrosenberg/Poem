 ...
 */
myapp.controller("homeCtrl",function($scope,dataFactory,$http,$state,$ionicViewSwitcher){

    $scope.data=dataFactory.query();
    //下拉刷新
    $scope.refresh=function(){
//      $http.get("../data.json").success(function(_data){
//          $scope.data.productList=_data;
//      }).finally(function(){
...
//                  //    $scope.data.productList.push(info);
//                  //});
//                  Array.prototype.push.apply($scope.data.productList,data.info);
